<template>
  ...
  <div class="card offset-2 col-md-3">
    <div class="card-body tex-center d-flex align-items-center flex-column">
      ...
      <button class="btn btn-outline-secondary" type="button" @click="$refs.file.click()">Select Picture</button>
    </div>
  </div>
  <div class="col-md-5">
    <div class="col-md-11 card">
      <div class="card-body">
        <div class="form-group">
          <label>Name</label>
          <input type="text" v-model="product.title" class="form-control" placeholder="product of name">
        </div>
        <div class="row">
          <div class="form-group col-md-6">
            <label>Number</label>
            <input type="text" v-model="product.count" class="form-control" placeholder="number of products">
          </div>
          <div class="form-group col-md-6">
            <label>Price</label>
  ...
  export  default  {
     ...
     methods : {
       ...
       addProduct() {
         ...
         this. product = { title : null,  count : null, price : null, totalPrice : null, selectedImage: null
         }
       }
     }
   }
